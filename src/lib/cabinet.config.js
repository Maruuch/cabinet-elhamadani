export const CABINET = {
  ...
  nomLigne1: {
    ar: "ÙÙØªØ¨ Ø§ÙØ­ÙØ¯Ø§ÙÙ",
    fr: "Cabinet Elhamadani",
  },

  nomLigne2: {
    ar: "ÙÙÙØ­Ø§ÙØ§Ø© ÙØ§ÙØ§Ø³ØªØ´Ø§Ø±Ø§Øª Ø§ÙÙØ§ÙÙÙÙØ©",
  ...
  stats: [
    { value: 5, suffix: "+", label: { ar: "Ø³ÙÙØ§Øª Ø§ÙØ®Ø¨Ø±Ø©", fr: "Ans d'expÃ©rience" } },
    { value: 100, suffix: "+", label: { ar: "ÙØ¶ÙØ© ÙØ§Ø¬Ø­Ø©", fr: "Dossiers traitÃ©s" } },
